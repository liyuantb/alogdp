...
train_questions, train_paragraphs = read_data("hw7_train.simple.json")
# 这里的dev就是validate
dev_questions, dev_paragraphs = read_data("hw7_dev.simple.json")
test_questions, test_paragraphs = read_data("hw7_test.simple.json")

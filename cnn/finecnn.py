...
class Data:
  ...
  def load_pytorch_dataset(self, batch_size):
    ...
    self.train_loader = DataLoader(train_set, batch_size, shuffle=True, num_workers=0, pin_memory=True)

    valid_set = FoodDataset(self.validate_data_dir, tfm=test_tfm)
    self.valid_loader = DataLoader(valid_set, batch_size, shuffle=True, num_workers=0, pin_memory=True)

    test_set = FoodDataset(self.test_data_dir, tfm=test_tfm)
    self.test_loader = DataLoader(test_set, batch_size, shuffle=False, num_workers=0, pin_memory=True)

    test_set = FoodDataset(self.test_data_dir, tfm=train_tfm)
    self.test_loader_extra1 = DataLoader(test_set, batch_size, shuffle=False, num_workers=0, pin_memory=True)

    test_set = FoodDataset(self.test_data_dir, tfm=train_tfm)
    self.test_loader_extra2 = DataLoader(test_set, batch_size, shuffle=False, num_workers=0, pin_memory=True)

    test_set = FoodDataset(self.test_data_dir, tfm=train_tfm)
    self.test_loader_extra3 = DataLoader(test_set, batch_size, shuffle=False, num_workers=0, pin_memory=True)
